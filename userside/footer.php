<!-- Footer Start -->
<div class="container-fluid bg-dark text-light py-5 wow fadeInUp" data-wow-delay="0.3s" style="margin-top:60px;">
    <div class="container pt-5">
        <div class="row g-5 pt-4">
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-light mb-2" href="service.php"><i class="bi bi-arrow-right text-primary me-2"></i>Our
                        Services</a>
                    <a class="text-light mb-2" href="medical_news.php"><i
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex flex-column justify-content-start">
                    <a class="text-light mb-2" href="view_appointment.php"><i
                            class="bi bi-arrow-right text-primary me-2"></i>View Appointment</a>
                    <a class="text-light mb-2" href="search_doctor.php"><i
                            class="bi bi-arrow-right text-primary me-2"></i>Make
                        Appointment</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
